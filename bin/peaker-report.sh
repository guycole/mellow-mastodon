...
#
psql $PGDATABASE -c "select freq_hz, obs_first, obs_last, population, name, case_uuid from mastodon_v1.population inner join mastodon_v1.site on site_id = site.id order by freq_hz;" > $REPORT_FILE_NAME
#
